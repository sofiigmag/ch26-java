...
public class ArrayListConceptos {
	...
	public static void main(String[] args) {
		...
		// ArrayList<int> calificaciones; Esto no se puede realizar, en su lugar hay que hacer:
		...
		nombreLibros.add("Hanzel y Gretel");
		...
		// Mostrat un elemento en particular
		// Indicara el número de índice, usando el método get()
		System.out.println("David recomienda: " + nombreLibros.get(3));
		
		// Removemos un elemento de la colección
		// indicamos el índice, usando el método remove()
		...
		System.out.println("Está Quiúbole con: " + nombreLibros.contains("Quiúbule con"));
