...
--
-- Host: localhost    Database: ch26-ecommerce
-- ------------------------------------------------------
...
CREATE TABLE `orders` (
  ...
  KEY `fk_order_has_customer_idx` (`customer_id`),
  CONSTRAINT `fk_order_has_customer` FOREIGN KEY (`customer_id`) REFERENCES `customers` (`customer_id`) ON DELETE RESTRICT ON UPDATE RESTRICT
...
CREATE TABLE `orders_has_products` (
  ...
  KEY `fk_orders_has_products_orders1_idx` (`orders_order_id`),
  CONSTRAINT `fk_orders_has_products_orders1` FOREIGN KEY (`orders_order_id`) REFERENCES `orders` (`order_id`),
...
-- Dump completed on 2023-05-30 15:50:31
